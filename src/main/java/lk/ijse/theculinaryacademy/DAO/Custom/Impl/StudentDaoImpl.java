...
import lk.ijse.theculinaryacademy.config.FactoryConfiguration;
...
public class StudentDaoImpl implements StudentDao {
    ...
    public boolean delete(String id) throws IOException {
        ...
        try {
            ...
            int result = nativeQuery.executeUpdate(); // Returns number of rows affected
            ...
            throw new IOException("Error while deleting student: " + e.getMessage(), e);
        }
    }

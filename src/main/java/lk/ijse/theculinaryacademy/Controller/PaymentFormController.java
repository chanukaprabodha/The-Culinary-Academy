...
import lk.ijse.theculinaryacademy.BO.Custom.StudentCourseBo;
import lk.ijse.theculinaryacademy.DAO.Custom.PaymentDao;
import lk.ijse.theculinaryacademy.DAO.Custom.StudentCourseDao;
...
import lk.ijse.theculinaryacademy.EntityTm.PaymentTm;
...
public class PaymentFormController {
    ...
    PaymentBo paymentBo = (PaymentBo) BoFactory
            .getBoFactory()
            .getBoType(BoFactory.BoType.PAYMENT);
    ...
    private void getAllStudentCourses() throws IOException {
        StudentCourseBo studentCourseBo = (StudentCourseBo) BoFactory
                .getBoFactory()
                .getBoType(BoFactory.BoType.STUDENT_COURSE);
    ...
    private String generateNewId() throws IOException {
        PaymentDao paymentDao = (PaymentDao) DaoFactory
                .getDaoFactory()
                .getDaoType(DaoFactory.DaoType.PAYMENT);
    ...
    void btnSaveOnAction(ActionEvent event) throws IOException {
        ...
        // Retrieve and process input data
        StudentCourseDao studentCourseDao = (StudentCourseDao) DaoFactory
                .getDaoFactory()
                .getDaoType(
                        DaoFactory
                        .DaoType
                        .STUDENT_COURSE);
        Student_Course studentCourse = studentCourseDao
                .getStudentCourseById(
                        Long.valueOf(txtStuCouDetail.getText()));
    ...
    void comboStudentOnAction(ActionEvent event) {
        ...
        System.out.println( "StudentCourseObservableList: " + studentCourseObservableList);
